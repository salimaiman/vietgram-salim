    ...
    <main id="feed">
        ...
        <div class="photo">
            <header class="photo__header">
                <img src="images/<?php echo $_SESSION['username'];?>/avatar.jpg" class="photo__avatar" />
                <div class="photo__user-info">
                    <span class="photo__author"><?php echo $_SESSION['username'];?></span>
                </div>
            </header>
            <center><img class="img-fluid" height="400px" width="400px" src="images/<?php echo $_SESSION['username']."/".$rows[$i][1]; ?>" /></center>
            <div class="photo__info">
                ...
                <?php echo $rows[$i][2]; ?><br><br>
                    ...
                    <span class="photo__action">
                        <i class="fa fa-bookmark-o fa-lg" style="float : right;"></i>
                    </span>
                </div>
