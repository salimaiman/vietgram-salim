<?php
    session_start();
    include("koneksi.php");
    $data_photo = mysqli_query($conn,"select * from tbl_photo where username='". $_SESSION['username']. "'");
    ...
    <main id="profile">
        <header class="profile__header">
            <div class="profile__column">
                <img width="200px" height="200px" src="images/<?php echo $_SESSION['username'];?>/avatar.jpg" />
            </div>
            <div class="profile__column">
                ...
                <p class="profile__bio">
                    ...
                    <a href="<?php echo $_SESSION['website'];?>" target="_blank"><?php echo $_SESSION['website'];?></a>
                </p>
            </div>
        </header>
        ...
        ?>
            <div class="profile__photo rounded">
                <img class="rounded mx-auto d-block" width="300px" height="300px" src="images/<?php echo $_SESSION['username']."/".$rows[$i][1]; ?>" />
