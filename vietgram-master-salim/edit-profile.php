        ...
        <div class="edit-profile__container">
            <header class="edit-profile__header">
                <div class="edit-profile__avatar-container">
                    <img src="images/<?php echo $_SESSION['username'];?>/avatar.jpg" class="edit-profile__avatar" />
                </div>
            ...
            <form action="editprofile.php" class="edit-profile__form" method="post">
                ...
                <div class="form__row">
                    ...
                    <input name="no_hp" type="tel" class="form__input" value="<?php echo $_SESSION['no_hp']?>"/>
                </div>
                <div class="form__row">
